...
export default function CartSlider( { cart, cartIsLoading, open, setCartSliderIsOpen }: any ) {
                                                        ...
                                                        { cart?.items?.length > 0 &&
                                                            cart.items.map( ( item: CartItem ) => (
                                                                <li key={ item.id } className='flex py-6'>
                                                                    <div
                                                                        className='relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200'>
                                                                        <Image
                                                                            src={ item.product?.images ? item.product?.images[0]?.file?.url! : '' }
